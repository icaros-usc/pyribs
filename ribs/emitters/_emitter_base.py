...
class EmitterBase(ABC):
    ...
    Args:
        ...
        bounds (None or array-like): Bounds of the solution space. Pass None to
            ...
            Child classes may choose not to use these bounds at all.
    """
    ...
    def tell(self, solutions, objective_values, behavior_values):
        """Directly inserts entries into the archive by calling
        :meth:`~ribs.archives.ArchiveBase.add`.

        This parent implementation (in :class:`~ribs.emitters.EmitterBase`) is
        enough for simple emitters like :class:`~ribs.emitters.GaussianEmitter`,
        but more complex emitters will almost certainly need to override it.
