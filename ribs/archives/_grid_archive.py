    ...
    *thresholds*, as introduced in `Fontaine 2023
    ...
    def __init__(
        ...
        *,
        ...
        self._qd_score_offset = np_scalar(qd_score_offset, self.dtypes["objective"])
    ...
    def _stats_update(self, new_objective_sum, new_best_index):
        ...
        self._stats = ArchiveStats(
            num_elites=len(self),
            coverage=np_scalar(len(self) / self.cells, dtype=self.dtypes["objective"]),
    ...
    def cqd_score(
        ...
        Raises:
            ...
            ValueError: target_points or penalties is an array with the wrong
                shape.
        """
        if not (hasattr(self, "upper_bounds") and hasattr(self, "lower_bounds")) and (
