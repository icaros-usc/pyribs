...
@image_comparison(baseline_images=["3d_custom_order"],
                  remove_text=False,
                  extensions=["png"])
...
@image_comparison(baseline_images=["3d_custom_names"],
                  remove_text=False,
                  extensions=["png"])
...
@image_comparison(baseline_images=["3d_coolwarm"],
                  remove_text=False,
                  extensions=["png"])
...
@image_comparison(baseline_images=["3d_width2_alpha2"],
                  remove_text=False,
                  extensions=["png"])
...
@image_comparison(baseline_images=["3d_custom_objective_limits"],
                  remove_text=False,
                  extensions=["png"])
...
@image_comparison(baseline_images=["3d_vertical_cbar"],
                  remove_text=False,
                  extensions=["png"])
