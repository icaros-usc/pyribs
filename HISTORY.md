...
#### API
- **Backwards-incompatible:** Made it such that each archive is initialized fully
- in its constructor instead of needing a separate .initialize(solution_dim) call(#200)
