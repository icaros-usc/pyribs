...
A _bare-bones_ quality diversity optimization library. Our library is the official implementation of the Covariance Matrix Adaptation MAP-Elites algorithm and implements the _Rapid Illumination of Behavior Spaces (RIBS)_ redesign of MAP-Elites detailed in the paper [Covariance Matrix Adapation for the Rapid Illumination of Behavior Sapce](https://arxiv.org/abs/1912.02400).
